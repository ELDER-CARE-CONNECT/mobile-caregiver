...
// ==========================================================
$sql = "SELECT id_don_hang, ten_khach_hang, id_nguoi_cham_soc, ngay_dat, tong_tien, trang_thai 
        FROM don_hang 
        WHERE so_dien_thoai = ?";
