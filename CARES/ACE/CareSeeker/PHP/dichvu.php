      ...
      <?php while ($row = $result->fetch_assoc()): ?>
        <div class="card" data-name="<?php echo strtolower($row['ho_ten']); ?>"
          ...
          <div class="card-content">
            ...
            <a href="chitiet_chamsoc.php?id=<?php echo $row['id_cham_soc']; ?>" class="btn-detail">Xem chi tiết</a>
            <a href="dat_dichvu.php?id=<?php echo $row['id_cham_soc']; ?>" class="btn-detail"> Đặt dịch vụ ngay</a>
