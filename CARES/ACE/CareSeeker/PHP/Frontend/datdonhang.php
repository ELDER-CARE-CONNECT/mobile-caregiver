...
const API_CAREGIVER_DETAIL = `../Backend/api_caregiver.php?action=get_details&id=${CAREGIVER_ID}`;
const API_PROFILE_GET = '../Backend/api_profile.php';
const API_ORDER_CREATE = '../Backend/api_order_create.php'; 
