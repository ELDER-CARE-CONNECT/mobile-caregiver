...
session_name("CARES_SESSION"); // ✅ thêm dòng này
...
$sql_ncs = "SELECT * FROM nguoi_cham_soc 
...
if ($result_ncs->num_rows > 0) {
    ...
    // Lưu session caregiver
    $_SESSION['role']           = 'nguoi_cham_soc';
    $_SESSION['caregiver_id']   = (int)$ncs['id_cham_soc'];
    $_SESSION['ten_tai_khoan']  = $ncs['ten_tai_khoan'];
    $_SESSION['ho_ten']         = $ncs['ho_ten'];
    $_SESSION['anh_dai_dien']   = $ncs['hinh_anh'];   // ✨ Quan trọng
    $_SESSION['dia_chi']        = $ncs['dia_chi'];
    $_SESSION['tuoi']           = $ncs['tuoi'];
    $_SESSION['gioi_tinh']      = $ncs['gioi_tinh'];

    // tự động trả đúng dữ liệu Vy như trước
